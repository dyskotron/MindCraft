...
namespace MindCraft.Data
{
    ...
    /// Generic base class loading Scriptable objects from given folder and providing them as a collection or by Id
        ...
        public virtual void PostConstruct()
        {
            foreach (var enumValue in Enum.GetValues(typeof(TEnum)))
            {
                ...
                if (actionCardDefinition != null)
                {
                    ...
                    Debug.LogErrorFormat("<color=\"red\">{0}.Init - Failed to load definition with id: {1}</color>", this, name);
            }  
