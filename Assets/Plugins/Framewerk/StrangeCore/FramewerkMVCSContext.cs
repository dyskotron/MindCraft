...
{
	public class FramewerkMVCSContext : FramewerkCrossContext
	{
		...
		public FramewerkMVCSContext(MonoBehaviour view) : base(view)
		{
		}

		public FramewerkMVCSContext(MonoBehaviour view, ContextStartupFlags flags) : base(view, flags)
		{
		}

		public FramewerkMVCSContext(MonoBehaviour view, bool autoMapping) : base(view, autoMapping)
		{
		}
		...
		protected override void instantiateCoreComponents()
		{
			...
			if (contextView == null)
			{
				throw new ContextException("FramewerkMVCSContext requires a ContextView of type MonoBehaviour", ContextExceptionType.NO_CONTEXT_VIEW);
			}
