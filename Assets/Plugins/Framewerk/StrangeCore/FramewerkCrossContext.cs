...
namespace Framewerk.StrangeCore
{
	public class FramewerkCrossContext : Context, ICrossContextCapable
	{
		...
		{
			get { return _injectionBinder ?? (_injectionBinder = new DestroyingBinder()); }
		...
		public FramewerkCrossContext() : base()
		{}

		public FramewerkCrossContext(object view) : base(view)
		{
		}

		public FramewerkCrossContext(object view, ContextStartupFlags flags) : base(view, flags)
		{
		}

		public FramewerkCrossContext(object view, bool autoMapping) : base(view, autoMapping)
		{
		}
