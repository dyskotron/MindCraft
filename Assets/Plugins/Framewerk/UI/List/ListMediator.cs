...
namespace Framewerk.UI.List
{
    ...
    /// </summary>
    /// <typeparam name="TView">View script attached to container gameobject</typeparam>
    ...
    public class ListMediator<TView, TData> : ListBaseMediator<TView, TData>, IListMediator<TData>  where TView : ListView
